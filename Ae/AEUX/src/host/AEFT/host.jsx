...
var AEUX = (function () {
    ...
    function filterTypes(layerData, opt_parent) {
        ...
        for (var i = 0; i < layerData.length; i++) {
            try {
                ...
                var skippedName = (layerData[i] && layerData[i].name) ? layerData[i].name : ('layer ' + i);
                returnMessage.push('Skipped "' + skippedName + '": ' + layerErr.toString());
                pbar.value += progressInc;
            }
        }
    }
    function aeText(layer, opt_parent) {
        ...
        try {
            ...
            returnMessage.push('Text layer "' + (layer && layer.name ? layer.name : 'unknown') + '": ' + e.toString());
        }
